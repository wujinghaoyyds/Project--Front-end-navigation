(function () {
  ...
  // logoType: 'text',
  // logotype: 'image',
  const $16b5ad875ae907e2f7f79e7b8fe116cc$var$simplityUrl = url => {
    ...
    $16b5ad875ae907e2f7f79e7b8fe116cc$var$hashMap.forEach((node, index) => {
      let $li = $(`<li>  
        ...
        <div class="logo">${node.logo[0]}</div>
            <div class="link">${$16b5ad875ae907e2f7f79e7b8fe116cc$var$simplityUrl(node.url)}</div>
            <div class="close">
            <svg class="icon">
  ...
  $('.addButton').on('click', () => {
    ...
    $16b5ad875ae907e2f7f79e7b8fe116cc$var$hashMap.push({
      logo: $16b5ad875ae907e2f7f79e7b8fe116cc$var$simplityUrl(url)[0],
      // logoType: 'text',
      url: url
    });
    $16b5ad875ae907e2f7f79e7b8fe116cc$var$render();
...
//# sourceMappingURL=index.37e015d6.js.map
